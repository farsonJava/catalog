...
corresponds to their fields. This latter point speaks to the scalability of the approach; if we wanted to introduce a new item, our hashmap data structure is already primed to snap into place- we can define a new cart item only using front-end request parameters need since
