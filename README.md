...
The email property is the bridge which associates users  with other types of data and enables them to have a decoupled relationship. The CartManager is entirely seperate
